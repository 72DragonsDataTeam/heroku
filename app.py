...
#mannheim-heidelberg = pd.read_csv('Mannheim-Heidelberg_data.csv', index_col='tconst')
...
gijon = pd.read_csv('Gijon_data.csv', index_col = 'tconst')
giffoni = pd.read_csv('Giffoni_data.csv', index_col = 'tconst')
norwegian = pd.read_csv('Norwegian_data.csv', index_col = 'tconst')
brussels = pd.read_csv('Brussels_data.csv', index_col='tconst')
#flanders = pd.read_csv('Flanders_data.csv', index_col = 'tconst')
#odense = pd.read_csv('Odense_data.csv', index_col='tconst')
#dramashort = pd.read_csv('Dramashort_data.csv', index_col='tconst')
goteborg = pd.read_csv('Goteborg_data.csv', index_col='tconst')
cinematographers = pd.read_csv('Cinematographers_data.csv', index_col='tconst')
nantes = pd.read_csv('Nantes_data.csv', index_col='tconst')
istanbul = pd.read_csv('Istanbul_data.csv', index_col='tconst')
brusselsfantasy = pd.read_csv('BrusselsFantasy_data.csv', index_col='tconst')
warsaw = pd.read_csv('Warsaw_data.csv', index_col='tconst')
leeds = pd.read_csv('Leeds_data.csv', index_col='tconst')
stockholm = pd.read_csv('Stockholm_data.csv', index_col='tconst')
hamburg = pd.read_csv('Hamburg_data.csv', index_col='tconst')
oldenburg = pd.read_csv('Oldenburg_data.csv', index_col='tconst')
sarajevo = pd.read_csv('Sarajevo_data.csv', index_col='tconst')
Jihlava = pd.read_csv('Jihlava_data.csv', index_col='tconst')
Tallinn = pd.read_csv('Tallinn_data.csv', index_col='tconst')
Bergen = pd.read_csv('Bergen_data.csv', index_col='tconst')
Neuchatel = pd.read_csv('Neuchatel_data.csv', index_col='tconst')
...
def choose_festival(continent):
    ...
    if continent == 'Europe':
        options = [
            ...
            #{'label': 'International Film Festival Mannheim-Heidelberg', 'value': 'Mannheim-Heidelberg'},
            #{'label': 'San Sebastian International Film Festival', 'value': 'Sansebastian'},
            ...
            {'label': 'Gijon International Film Festival', 'value': 'Gijon'},
            {'label': 'Giffoni Film Festival', 'value': 'Giffoni'},
            {'label': 'Norwegian International Film Festival', 'value':'Norwegian'},
            {'label': 'Brussels International Independent Film Festival', 'value':'Brussels'},
            #{'label': 'Flanders International Film Festival Ghent', 'value':'Flanders'},
            #{'label': 'Odense International Film Festival', 'value': 'Odense'},
            #{'label': 'Drama International Short Film Festival', 'value': 'Dramashort'},
            {'label': 'Goteborg International Film Festival', 'value': 'Goteborg'},
            {'label': 'International Cinematographers Film Festival Manaki Brothers', 'value': 'Cinematographers'},
            {'label': 'Nantes Three Continents Festival', 'value': 'Nantes'},
            {'label': 'Istanbul International Film Festival', 'value': 'Istanbul'},
            {'label': 'Brussels International Fantastic Film Festival', 'value': 'BrusselsFantasy'},
            {'label': 'Warsaw International Film Festival', 'value': 'Warsaw'},
            {'label': 'Leeds International Film Festival', 'value': 'Leeds'},
            {'label': 'Stockholm International Film Festival', 'value': 'Stockholm'},
            {'label': 'Hamburg Film Festival', 'value': 'Hamburg'},
            {'label': 'Oldenburg International Film Festival', 'value': 'Oldenburg'},
            {'label': 'Sarajevo Film Festival', 'value': 'Sarajevo'},
            {'label': 'Jihlava International Documentary Film Festival', 'value': 'Jihlava'},
            {'label': 'Tallinn International Documentary Film Festival', 'value': 'Tallinn'},
            {'label': 'Bergen International Film Festival', 'value': 'Bergen'},
            {'label': 'Neuchatel International Fantastic Film Festival', 'value': 'Neuchatel'}
...
def update_graph(festival_name, genre_name):
    ...
    #    s, s_winner, s_loser = newDataset(mannheim-heidelberg, genre_name)

    #elif festival_name == 'Sansebastian':
    #    s, s_winner, s_loser = newDataset(sansebastian, genre_name)
    ...
    elif festival_name == 'Gijon':
        s, s_winner, s_loser = newDataset(gijon, genre_name)

    elif festival_name == 'Giffoni':
        s, s_winner, s_loser = newDataset(giffoni, genre_name)

    elif festival_name == 'Norwegian':
        s, s_winner, s_loser = newDataset(norwegian, genre_name)

    elif festival_name == 'Brussels':
        s, s_winner, s_loser = newDataset(brussels, genre_name)

    #elif festival_name == 'Flanders':
    #    s, s_winner, s_loser = newDataset(flanders, genre_name)

    #elif festival_name == 'Odense':
    #    s, s_winner, s_loser = newDataset(odense, genre_name)

    #elif festival_name == 'Dramashort':
    #    s, s_winner, s_loser = newDataset(dramashort, genre_name)

    elif festival_name == 'Goteborg':
        s, s_winner, s_loser = newDataset(goteborg, genre_name)

    elif festival_name == 'Cinematographers':
        s, s_winner, s_loser = newDataset(cinematographers, genre_name)

    elif festival_name == 'Nantes':
        s, s_winner, s_loser = newDataset(nantes, genre_name)

    elif festival_name == 'Istanbul':
        s, s_winner, s_loser = newDataset(istanbul, genre_name)

    elif festival_name == 'BrusselsFantasy':
        s, s_winner, s_loser = newDataset(BrusselsFantasy, genre_name)

    elif festival_name == 'Warsaw':
        s, s_winner, s_loser = newDataset(Warsaw, genre_name)

    elif festival_name == 'Leeds':
        s, s_winner, s_loser = newDataset(Leeds, genre_name)

    elif festival_name == 'Stockholm':
        s, s_winner, s_loser = newDataset(Stockholm, genre_name)

    elif festival_name == 'Hamburg':
        s, s_winner, s_loser = newDataset(Hamburg, genre_name)

    elif festival_name == 'Oldenburg':
        s, s_winner, s_loser = newDataset(Oldenburg, genre_name)

    elif festival_name == 'Sarajevo':
        s, s_winner, s_loser = newDataset(Sarajevo, genre_name)

    elif festival_name == 'Jihlava':
        s, s_winner, s_loser = newDataset(Jihlava, genre_name)

    elif festival_name == 'Tallinn':
        s, s_winner, s_loser = newDataset(Tallinn, genre_name)

    elif festival_name == 'Bergen':
        s, s_winner, s_loser = newDataset(Bergen, genre_name)

    elif festival_name == 'Neuchatel':
        s, s_winner, s_loser = newDataset(Neuchatel, genre_name)
